...
function ProductDetail({title}) {
    ...
    const { loading, products } = useSelector((state)=>state.pDetail)
                ...
                <div className="row px-xl-5">
                    <div className="col-12">
                        <nav className="breadcrumb bg-light mb-30">
                            ...
                            <Link className="breadcrumb-item text-dark" to="/product">Shop</Link>
                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner bg-light">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src={products?.images?.url} alt="Image" />
                                </div>
                            ...
                            <div className="product-item bg-light">
                                <div className="product-img position-relative overflow-hidden">
                                    ...
                                    <div className="product-action">
                                        <a className="btn btn-outline-dark btn-square" to=""><i className="fa fa-shopping-cart"></i></a>
                                        <a className="btn btn-outline-dark btn-square" to=""><i className="far fa-heart"></i></a>
                                        <a className="btn btn-outline-dark btn-square" to=""><i className="fa fa-sync-alt"></i></a>
                                        <a className="btn btn-outline-dark btn-square" to=""><i className="fa fa-search"></i></a>
                                    </div>
                                </div>
                                <div className="text-center py-4">
                                    <a className="h6 text-decoration-none text-truncate" to="">Product Name Goes Here</a>
